...
export default function FeaturedVideosCarousel() {
  ...
  return (
    <section
      className="bg-lightBackground dark:bg-darkBackground text-lightText dark:text-darkText py-16 transition-colors duration-100 ease-in-out mt-12"
      {...(isSmallScreen ? swipeHandlers : {})}
    >
      <div className="container mx-auto max-w-[1200px] text-center">
        {/* Section Title */}
        <h2 className="text-orangeGold dark:text-gold font-bold text-3xl md:text-5xl mb-12">
          ICPAK Certification Courses
        </h2>
